...
Miku.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                mikutext = `
		*━━━━▣━━◤❄️◢━━▣━━━━━*
*السلام عليكم ورحمة لله وبركاته يا*❄️🤍
 @${WAuserName.split("@")[0]},

نورت أنا البوتة نيرو مرحبا بك في مجموعة 🫧☃️ :*,  ${metadata.subject}.

لو بدك أوامري أكتب 《-الاوامر》 أتمنى لك يوما سعيدا يا أيها   المغامر/ة* 🔱🤍
